...
http_1.default.createServer((req, res) => {
    ...
    if ((reqUrl === null || reqUrl === void 0 ? void 0 : reqUrl.match(/\/[todo]+\/([a-z]|[0-9]|[-])+/g)) && req.method == reqMethod_1.reqMethod.GET) {
        // fetching todo w.r.t id
        (0, getTodoWithId_1.getTodoWithId)(req, res);
    }
    else if ((reqUrl === null || reqUrl === void 0 ? void 0 : reqUrl.match(/\/[todo]+/g)) && req.method == reqMethod_1.reqMethod.POST) {
        // add todos to file
        (0, collectDataChuncks_1.collectDataChuncks)(req, res, addTodo_1.addTodo);
    }
    else if ((reqUrl === null || reqUrl === void 0 ? void 0 : reqUrl.match(/\/[todo]+\/([a-z]|[0-9]|[-])+/g)) && req.method == reqMethod_1.reqMethod.PUT) {
        // update Todos
        (0, collectDataChuncks_1.collectDataChuncks)(req, res, updateTodo_1.updateTodo);
    }
    else if ((reqUrl === null || reqUrl === void 0 ? void 0 : reqUrl.match(/\/[todo]+\/([a-z]|[0-9]|[-])+/g)) && req.method == reqMethod_1.reqMethod.DELETE) {
        // delete Todo
        (0, deleteTodo_1.deleteTodo)(req, res);
    }
    else if ((reqUrl === null || reqUrl === void 0 ? void 0 : reqUrl.match(/\/[todo]+/)) && req.method == reqMethod_1.reqMethod.GET) {
        // queries on Todo
